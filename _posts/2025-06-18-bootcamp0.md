...
public class Operator12 {
	...
	public static void main(String[] args) {
		...
		System.out.println("flase && ture :" +flag2);
		
		boolean flag3 = (num1 > 0) && (num2 == 20);
		System.out.println("ture && ture :" + flag3);
		
		System.out.println("-----OR------");
		
		boolean flag4 = (num1 > 10) || (num2 > 20);
		System.out.println("flase || flase :" + flag4);
		boolean flag5 = (num1 >= 10) || (num2 > 20);
		System.out.println("ture || flase :" + flag5);
		boolean flag6 = (num1 >= 10) || (num2 >= 20);
		System.out.println("ture || ture :" + flag6);
